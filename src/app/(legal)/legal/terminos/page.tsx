...
export const metadata = buildMetadata({
  ...
  description: "Términos y condiciones de Asecuritech con enfoque en transparencia y cumplimiento.",
  path: "/legal/terminos"
});
  ...
  return (
    <main className="section-space">
      <div className="container-page max-w-4xl prose-copy">
        <h1 className="text-4xl font-semibold tracking-tight sm:text-5xl">Términos y condiciones</h1>
        <p>
